...
const reasonLabels: Partial<
  Record<NonNullable<FetcherStatusResponse["reason"]>, string>
> = {
...
export default function FetcherRow({ fetcher }: FetcherRowProps) {
  ...
  const reasonLabel =
    (fetcher.reason ? reasonLabels[fetcher.reason] : undefined) ||
    "Unknown Status";
  ...
  return (
    ...
    >
      ...
      <TrafficLight color={statusColors[status]} label={reasonLabel} />
    </Box>
  );
}
