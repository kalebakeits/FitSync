  ...
  return (
    <Box>
      <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
        Connect AI assistants to FitSync via MCP. Paste the MCP URL into your AI
        tool — it will handle authentication automatically. If your tool
        requires a token, create one below.
      </Typography>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
        Each token represents a connected app. Delete a token to revoke its
        access.
      </Typography>
      ...
      <Dialog open={createOpen} onClose={handleClose} maxWidth="xs" fullWidth>
        <DialogTitle>
          {createdToken ? "Token created" : "New token"}
        </DialogTitle>
        <DialogContent>
          {createdToken ? (
            <Box>
