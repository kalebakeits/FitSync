...
export default function TrainingProfileForm() {
  ...
  const [runningThresholdPaceSeconds, setRunningThresholdPaceSeconds] =
    useState("");
  ...
  useEffect(() => {
    ...
    setRunningThresholdPaceSeconds(
      data.runningThresholdPaceSeconds?.toString() ?? "",
    );
    ...
    mutation: {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: getGetApiTrainingProfileQueryKey(),
        });
      },
    },
  });
  ...
  const handleSave = () => {
    const request: UpsertTrainingProfileRequest = {
      ...
      cyclingThresholdHr: cyclingThresholdHr
        ? parseInt(cyclingThresholdHr)
        : null,
      cyclingMaxHr: cyclingMaxHr ? parseInt(cyclingMaxHr) : null,
      runningThresholdHr: runningThresholdHr
        ? parseInt(runningThresholdHr)
        : null,
      runningMaxHr: runningMaxHr ? parseInt(runningMaxHr) : null,
      runningThresholdPaceSeconds: runningThresholdPaceSeconds
        ? parseInt(runningThresholdPaceSeconds)
        : null,
      ...
      <Stack direction={rowDirection} spacing={2} sx={{ width: "100%" }}>
        <TextField
          ...
          slotProps={{
            input: {
              endAdornment: (
                <InfoTooltip title="Functional Threshold Power — max sustainable power for ~1 hour." />
              ),
            },
          }}
        />
        <TextField
          ...
          slotProps={{
            input: {
              endAdornment: (
                <InfoTooltip title="Heart rate at your cycling lactate threshold." />
              ),
            },
          }}
        />
        <TextField
          ...
          slotProps={{
            input: {
              endAdornment: (
                <InfoTooltip title="Maximum heart rate for cycling." />
              ),
            },
          }}
        />
      ...
      <Stack direction={rowDirection} spacing={2} sx={{ width: "100%" }}>
        <TextField
          ...
          slotProps={{
            input: {
              endAdornment: (
                <InfoTooltip title="Heart rate at your running lactate threshold." />
              ),
            },
          }}
        />
        <TextField
          ...
          slotProps={{
            input: {
              endAdornment: (
                <InfoTooltip title="Maximum heart rate for running." />
              ),
            },
          }}
        />
      ...
      <Stack direction={rowDirection} spacing={2} sx={{ width: "100%" }}>
        <TextField
          ...
          slotProps={{
            input: {
              endAdornment: (
                <InfoTooltip title="Length of your pool in metres. Used for pool swim workouts." />
              ),
            },
          }}
        />
        <TextField
          ...
          slotProps={{
            input: {
              endAdornment: (
                <InfoTooltip title="Heart rate at your swimming lactate threshold." />
              ),
            },
          }}
        />
