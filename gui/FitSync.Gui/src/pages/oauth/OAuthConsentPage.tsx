  ...
  return (
    <AuthLayout title="FitSync" subtitle="Authorize Access">
      <Typography variant="body1" sx={{ mb: 2, textAlign: "center" }}>
        <strong>{clientName}</strong> is requesting access to your FitSync
        account.
      </Typography>
      ...
      >
        This will allow {clientName} to read your activities and connected
        services via MCP.
      </Typography>
